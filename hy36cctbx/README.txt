...
A copy of the cctbx license is included (ctbx_LICENSE_2_0.tx).

================================================================================

All other scripts and files in this repository, which are not present in the 
"hy36cctbx" directory are licensed under under GNU general public license version 3. 
A copy of the same is included in the parent directory (../LICENSE).
